...
#define REG_HDMI_CP_AN1					(HDMI_BASE_ADDR+0x100)
#define REG_HDMI_CP_AN2					(HDMI_BASE_ADDR+0x104)
#define REG_HDMI_CP_BKSV1				(HDMI_BASE_ADDR+0x108)
#define REG_HDMI_CP_BKSV2				(HDMI_BASE_ADDR+0x10C)
#define REG_HDMI_CP_AKSV1				(HDMI_BASE_ADDR+0x110)
#define REG_HDMI_CP_AKSV2				(HDMI_BASE_ADDR+0x114)
#define REG_HDMI_CP_RI					(HDMI_BASE_ADDR+0x118)
#define REG_HDMI_CP_STATUS			(HDMI_BASE_ADDR+0x11C)
#define REG_HDMI_CP_CTRL			(HDMI_BASE_ADDR+0x120)
#define REG_HDMI_I2C_CTRL			(HDMI_BASE_ADDR+0x124)
#define REG_HDMI_CP_STATUS2			(HDMI_BASE_ADDR+0x12C)

#define REG_HDMI_I2C_CTRL2			(HDMI_BASE_ADDR+0x128)
#define REG_HDMI_CP_BSTATUS_RESTORE	(HDMI_BASE_ADDR+0x138)
#define REG_HDMI_WDT_CTRL			(HDMI_BASE_ADDR+0x13c)
#define REG_HDMI_CP_INT				(HDMI_BASE_ADDR+0x14c)
...
#define REG_HDMI_CP_KEY_SHUFFLE		(HDMI_BASE_ADDR+0x3f4)
...
#define REG_HDMI_CP_FIFO_ADDR		HDMI_CP_BASE_ADDR

// define REG_HDMI_CP_AN1,0x100
// define REG_HDMI_CP_AN2,0x104
// define REG_HDMI_CP_BKSV1,0x108
// define REG_HDMI_CP_BKSV2,0x10C
#define HDMI_CP_BKSV32_39			REG_HDMI_CP_BKSV2,0xFF,0
#define HDMI_CP_CIPHER_RI			REG_HDMI_CP_BKSV2,0xFFFF0000,16

// REG_HDMI_CP_AKSV1,0x110
// REG_HDMI_CP_AKSV2,0x114
#define HDMI_CP_AKSV_32_39			REG_HDMI_CP_BKSV2,0xFF,0
#define HDMI_CP_AKSV_READY			REG_HDMI_CP_BKSV2,BIT31,31

// REG_HDMI_CP_RI,0x118
#define HDMI_CP_TX_RI				REG_HDMI_CP_RI,0xFFFF,0
#define HDMI_CP_RX_RI				REG_HDMI_CP_RI,0xFFFF0000,16

// REG_HDMI_CP_STATUS,0x11C
#define HDMI_CP_AN_RDY				REG_HDMI_CP_STATUS,BIT0,0
#define HDMI_CP_AUTH_STATE			REG_HDMI_CP_STATUS,BIT1+BIT2,1
#define HDMI_CP_RI_RDY				REG_HDMI_CP_STATUS,BIT3,3
#define HDMI_CP_CP_EN				REG_HDMI_CP_STATUS,BIT4,4
#define HDMI_CP_REPEATER			REG_HDMI_CP_STATUS,BIT5,5
#define HDMI_CP_AUTH_PASS			REG_HDMI_CP_STATUS,BIT6,6
#define HDMI_CP_AUTH_DONE			REG_HDMI_CP_STATUS,BIT7,7
#define HDMI_CP_PJ_PASS				REG_HDMI_CP_STATUS,BIT8,8
#define HDMI_CP_PJ_DONE				REG_HDMI_CP_STATUS,BIT9,9
#define HDMI_CP_MI_READY			REG_HDMI_CP_STATUS,BIT10,10
#define HDMI_CP_IRQ_SRC				REG_HDMI_CP_STATUS,0x3800,11
#define HDMI_CP_DEV_CNT				REG_HDMI_CP_STATUS,0x1FC000,14
#define HDMI_CP_RI_CNT				REG_HDMI_CP_STATUS,0x1E00000,21
#define HDMI_CP_INT					REG_HDMI_CP_STATUS,BIT25,25
#define HDMI_CP_BCAPS_INFO			REG_HDMI_CP_STATUS,0xFC000000,26

//REG_HDMI_CP_CTRL,0x120
#define HDMI_EEPROM_RESET			REG_HDMI_CP_CTRL,BIT0,0
#define HDMI_ENCODE_ENABLE			REG_HDMI_CP_CTRL,BIT1,1
#define HDMI_CP_ENABLE				REG_HDMI_CP_CTRL,BIT2,2
#define HDMI_EESS_ENABLE			REG_HDMI_CP_CTRL,BIT3,3
#define HDMI_VERIFY_PJ_ENABLE		REG_HDMI_CP_CTRL,BIT4,4
#define HDMI_I2C_ENABLE				REG_HDMI_CP_CTRL,BIT5,5
#define HDMI_AUTH_TEST_KEY			REG_HDMI_CP_CTRL,BIT6,6
#define HDMI_CIPHER_1_1				REG_HDMI_CP_CTRL,BIT8,8
#define HDMI_CP_KEY_ENCODE			REG_HDMI_CP_CTRL,BIT9,9
#define HDMI_CPU_WR_CP_KEY_PATH		REG_HDMI_CP_CTRL,BIT10,10
#define HDMI_PREAMBLE				REG_HDMI_CP_CTRL,0xF000,12
...
// REG_HDMI_CP_STATUS2,0x12C
#define HDMI_CP_BSTATUS				REG_HDMI_CP_STATUS2,0xFFFF,0
#define HDMI_CP_BSTATUS_HDMI_MODE	REG_HDMI_CP_STATUS2,BIT12,12

// REG_HDMI_CP_BSTATUS_RESTORE,0x138
#define HDMI_CP_BSTATUS_RESTORE		REG_HDMI_CP_BSTATUS_RESTORE,BIT16,16

//REG_HDMI_WDT_CTRL,0x13c
#define HDMI_WDT_DIVIDER			REG_HDMI_WDT_CTRL,0x3FFFFFF,0	// timer divider for 100ms

//REG_HDMI_CP_INT,0x14c
#define HDMI_CP_KEY						REG_HDMI_CP_INT,0xFFFFFF,0
#define HDMI_CP_INT_ENABLE				REG_HDMI_CP_INT,BIT24,24
#define HDMI_CP_BCAP_FETCH_INT			REG_HDMI_CP_INT,BIT25,25
#define HDMI_CP_MAX_CASCADE_EXCEED_INT 	REG_HDMI_CP_INT,BIT26,26
#define HDMI_CP_MAX_DEVICE_EXCEED_INT 	REG_HDMI_CP_INT,BIT27,27
#define HDMI_CP_INT_CLR					REG_HDMI_CP_INT,BIT28,28
#define HDMI_CP_INT_STS					REG_HDMI_CP_INT,0xE0000000,29
...
//REG_HDMI_CP_KEY_SHUFFLE,0x3f4
#define HDMI_CP_KEY_SHUFFLE_MODE	REG_HDMI_CP_KEY_SHUFFLE,0x3,0
...
#if 0
#define HDMI_INFOFRAME_SRAM_ENABLE	REG_HDMI_TMDS_CTRL,BIT8,8
#define HDMI_CP_KEY_DEBUG_MODE		REG_HDMI_TMDS_CTRL,BIT9,9	// not used in B0
#else
#define HDMI_INFOFRAME_SRAM_ENABLE	REG_HDMI_TMDS_CTRL,BIT10,10
#define HDMI_CP_KEY_DEBUG_MODE		REG_HDMI_TMDS_CTRL,BIT8,8
#endif
