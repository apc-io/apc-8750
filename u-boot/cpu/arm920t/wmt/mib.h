...
VOID GSTAvUpdateRDStatCounter(PSStatCounter pStatistic, PSRxDesc prdCurr,
		PBYTE pbyBuffer, UINT cbFrameLength);

VOID GSTAvUpdateRDStatCounterEx(PSStatCounter pStatistic, PSRxDesc prdCurr,
		PBYTE pbyBuffer, UINT cbFrameLength,
		DWORD dwHwCRC32, DWORD dwSwCRC32);
...
VOID GSTAvUpdateHWMIBCounter(DWORD dwIoBase, PSHWMibCounter pCounter);
