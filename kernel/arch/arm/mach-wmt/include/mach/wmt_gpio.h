...
#define GPIO0_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO0_INT_REQ_TYPE_ADDR)
#define GPIO1_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO1_INT_REQ_TYPE_ADDR)
#define GPIO2_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO2_INT_REQ_TYPE_ADDR)
#define GPIO3_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO3_INT_REQ_TYPE_ADDR)
#define GPIO4_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO4_INT_REQ_TYPE_ADDR)
#define GPIO5_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO5_INT_REQ_TYPE_ADDR)
#define GPIO6_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO6_INT_REQ_TYPE_ADDR)
#define GPIO7_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO7_INT_REQ_TYPE_ADDR)
#define GPIO8_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO8_INT_REQ_TYPE_ADDR)
#define GPIO9_INT_REQ_TYPE_1BYTE_VAL 			REG8_VAL(GPIO9_INT_REQ_TYPE_ADDR)
#define GPIO10_INT_REQ_TYPE_1BYTE_VAL 		REG8_VAL(GPIO10_INT_REQ_TYPE_ADDR)
#define GPIO11_INT_REQ_TYPE_1BYTE_VAL 		REG8_VAL(GPIO11_INT_REQ_TYPE_ADDR)



#define GPIO_INT_REQ_STS_4BYTE_VAL 				REG32_VAL(GPIO_INT_REQ_STS_4BYTE_ADDR 			    )
